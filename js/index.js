...
// Fonction qui retourne un tableau des 5 derniers elements
function getLastProducts(products) {
  const lastProducts = products.slice(-5);
  return lastProducts;
}

// Fonction qui retourne un tableau des 8 elements avec les plus grand nbrVentes
function getMostSoldProducts(products) {
  const sortedProducts = products.sort((a, b) => b.nbrVentes - a.nbrVentes);
...
// Appel des fonctions pour les produits les plus récents et les plus vendus
const lastProducts = getLastProducts(products);
const mostSoldProducts = getMostSoldProducts(products);

lastProductsContent.innerHTML = ""; // Vider la liste
mostSoldProductsContent.innerHTML = ""; // Vider la liste
